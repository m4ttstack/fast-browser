  ...
  assert.deepEqual(lock, {
    ...
    runtime: {
      url: 'https://github.com/m4ttheweric/playwright/releases/download/'
        + 'fast-browser-v0.1.0-alpha.15/fast-browser-mcp-0.1.0-alpha.15.tar.gz',
      file: 'fast-browser-mcp-0.1.0-alpha.15.tar.gz',
      sha256: 'f65969b5c3e1d28b49311be9a1000038703bc7fbc691ad52f99129161adf7470',
      node: '>=20',
    },
    extension: {
      url: 'https://github.com/m4ttheweric/playwright/releases/download/'
        + 'fast-browser-v0.1.0-alpha.15/fast-browser-extension-0.1.0-alpha.15.zip',
      file: 'fast-browser-extension-0.1.0-alpha.15.zip',

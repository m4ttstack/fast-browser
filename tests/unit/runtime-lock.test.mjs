...
test('bundled lock pins the intended candidate identity and immutable artifact URLs', async () => {
  ...
  assert.deepEqual(lock, {
    schemaVersion: 1,
    productVersion: '0.1.0-alpha.9',
    sourceCommit: '1c3747d9a82d2c0ccfb4918e077106067218b6b2',
    protocolVersion: 2,
    runtime: {
      url: 'https://github.com/m4ttheweric/playwright/releases/download/'
        + 'fast-browser-v0.1.0-alpha.9/fast-browser-mcp-0.1.0-alpha.9.tar.gz',
      file: 'fast-browser-mcp-0.1.0-alpha.9.tar.gz',
      sha256: '152cc0d0730caeba2a1da66baf6685ade4b2e22fa73a9088b0ae6e405f5225ad',
      node: '>=20',
    },
    extension: {
      url: 'https://github.com/m4ttheweric/playwright/releases/download/'
        + 'fast-browser-v0.1.0-alpha.9/fast-browser-extension-0.1.0-alpha.9.zip',
      file: 'fast-browser-extension-0.1.0-alpha.9.zip',
      sha256: 'cc529a4374b8d7ce1936ab037fd8d78290dd7801805be5143f87315ac999ecba',

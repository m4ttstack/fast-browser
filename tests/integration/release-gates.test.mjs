...
// The CLI's default --source is the m4ttstack/fast-browser repo, so this file
// is what `claude plugin marketplace add` reads on a first install. MAT-378
// deleted it and broke that path for every new Claude machine; the version
// field drifting would break it just as quietly.

...
// package.json, not .codex-plugin/plugin.json — see the note in claude.mjs:
// a dotted directory cannot survive embedding in a signed macOS app bundle,
// and reading one at import time makes this module unloadable there.

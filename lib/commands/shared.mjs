...
// odd" property (fix round 2, item 4):
...
//   - U+200B ZERO WIDTH SPACE -- invisible, can be used to break up a
//     string a human is visually scanning without leaving a visible trace.

...
import {
  chmod, readdir, readFile, rename, stat, unlink, writeFile,
...
async function applyReplayRecords(replayRecords, registry, updatedByName, healed, healErrors, clock, ranker) {
...
export async function sweep({ paths, now, ranker } = {}) {
  ...
  for (const session of sessions) {
    ...
    if (replayRecords.length > 0) {
      ...
      await applyReplayRecords(replayRecords, registry, updatedByName, healed, healErrors, clock, ranker);
    }

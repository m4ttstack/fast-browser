...
// Any non-object `args` (missing, null, an array, a primitive) redacts to
// `null` rather than being silently coerced to `{}` -- that coercion was
// itself a small fabrication (asserting "no args" when the shape was
// actually unknown), and this module's standing rule (fix-round-1 "ADOPTED
// F8") is to never fabricate a plausible-looking value for degenerate
// input.

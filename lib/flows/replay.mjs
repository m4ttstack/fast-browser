...
// code it ran plus a JSON dump of the arguments it was handed. The
// arguments are this module's half of that bill: `flows find` used to hand
// the runner the ENTIRE stored artifact, provenance and prose included.
//

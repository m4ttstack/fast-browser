...
// tool-contract reads the catalog mcp-handshake leaves on the shared context,
// so selecting it alone would always report a malformed catalog.
export const DOCTOR_CHECK_PREREQUISITES = Object.freeze({
  'tool-contract': Object.freeze(['mcp-handshake']),
});
